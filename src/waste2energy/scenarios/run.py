...
def run_scenario_robustness_baseline(
    ...
    baseline_config = PlanningConfig(
        ...
        scenario_metric_adjustment_table_path=baseline_seed.scenario_metric_adjustment_table_path,
        scenario_metric_adjustments=baseline_seed.scenario_metric_adjustments,
