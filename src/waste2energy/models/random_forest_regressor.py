...
def build_model(config: RandomForestConfig | None = None) -> RandomForestRegressor:
    active_config = config or RandomForestConfig()
    return RandomForestRegressor(**asdict(active_config))
